...
$result2 = sqlsrv_query($conn,"SELECT [Date Worked], [ACTIVITY], SUM(Units) FROM DEFRTS.dbo.UnitLineBatch WHERE (ACTIVITY = 'SHP - SHEAR PLUCKING' OR ACTIVITY =  'HPL - HAND PLUCKING' OR ACTIVITY = 'MTH - MECHANICAL HARVESTING') AND ([Date Worked] BETWEEN '$startDate' AND '$endDate')GROUP BY [Date Worked],  ACTIVITY");
